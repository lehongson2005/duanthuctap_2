    ...
    <div class="row">
        <div class="col-lg-3 d-none d-lg-block">
            <div class="toc-sidebar">
                ...
                <nav>
                    <!-- Static TOC for now. Dynamic TOC requires JS parsing of content. -->
        ...
        <div class="col-lg-6 col-md-8">
            <div class="article-content">
                ...
                <div class="post-body">
                    <?php echo nl2br($post['content']); // Using nl2br to preserve line breaks. For HTML content, this should be removed. ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
            <div class="sidebar-right">
                ...
                <!-- Other static widgets can remain here -->
            </div>
        </div>
    </div>
    <?php else: ?>
