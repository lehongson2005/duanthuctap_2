...
<style>
    ...
    .product-options-seed .btn {
        border-radius: 5px !important;
        padding: 8px 15px;
        font-weight: bold;
    }
    .product-options-seed .btn-check:checked + .btn {
...
<section id="seed-list-section" class="mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="fw-bold mb-0">HẠT GIỐNG</h3>
        <?php if (isset($hatgiong_view_all_id)): ?>
        <a href="<?php echo BASE_URL; ?>/danhmuc.php?id=<?php echo $hatgiong_view_all_id; ?>" class="btn btn-outline-success btn-sm">
    ...
    <div class="nnp-product-slider-wrapper">
        ...
        <button class="nnp-slider-nav-btn nnp-prev-btn d-none d-lg-flex" onclick="scrollSlider('seed-list-slider', 'prev')">
            <i class="fas fa-chevron-left"></i>
        </button>

        <div class="nnp-product-slider" id="seed-list-slider">
            <?php if ($hatgiong_products && $hatgiong_products->num_rows > 0): ?>
                <?php while ($product = $hatgiong_products->fetch_assoc()): ?>
                    <div class="col">
        ...
        <button class="nnp-slider-nav-btn nnp-next-btn d-none d-lg-flex" onclick="scrollSlider('seed-list-slider', 'next')">
            <i class="fas fa-chevron-left"></i>
        </button>
    </div>
