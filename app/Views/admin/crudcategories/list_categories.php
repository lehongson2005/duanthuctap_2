...
$page_title = "Quản lý danh mục cấp 1";
...
$total_records = $categoryModel->getTotal($keyword, $status);
$total_pages = ceil($total_records / $limit);

// Get records for the current page
$categories = $categoryModel->searchAndFilter($keyword, $status, $limit, $offset);
?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold text-dark mb-0"><?php echo $page_title; ?></h2>
        <p class="text-muted small">Danh sách toàn bộ danh mục trong hệ thống</p>
    </div>
    <a href="add_category.php" class="btn btn-primary shadow-sm">
...
<div class="card shadow-sm border-0 rounded-4 mb-4">
    <div class="card-body">
        <form method="GET" action="">
            <div class="row g-3">
                <div class="col-md-6">
                    <input type="text" name="keyword" class="form-control" placeholder="Tìm theo tên..." value="<?php echo htmlspecialchars($keyword); ?>">
                </div>
                <div class="col-md-4">
                    ...
                    <?php if($categories->num_rows > 0): ?>
                        ...
                        <tr>
                            ...
                            <td class="pe-4 text-end">
                                <a href="edit_category.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                <a href="delete_category.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa?')"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
