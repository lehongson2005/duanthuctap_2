...
include_once '../../../../app/models/CategoryModel.php'; // For category filter

$page_title = "Quản lý Bài viết";
include_once '../templates/header.php';

$postModel = new PostModel($conn);
$categoryModel = new CategoryModel($conn); // For dropdown
...
$items = $postModel->searchAndFilter($keyword, $category_id, $status, null, null, $limit, $offset);
?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold text-dark mb-0"><?php echo $page_title; ?></h2>
        <p class="text-muted small">Danh sách toàn bộ bài viết trong hệ thống</p>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <select name="category_id" class="form-select">
                        ...
                        <?php mysqli_data_seek($all_categories, 0); // Reset pointer if used elsewhere ?>
                    ...
                    <?php if($items->num_rows > 0): ?>
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex small mt-1">
                                            ...
                                            <?php if($row['is_hot']==1): ?><span class="badge bg-danger">Hot</span><?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="pe-4 text-end">
                                <a href="edit_post.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                <a href="delete_post.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc muốn xóa bài viết này?')"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
