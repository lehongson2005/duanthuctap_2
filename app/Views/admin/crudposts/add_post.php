...
$data = [
    ...
    'author' => 'Admin', 'published_at' => date('Y-m-d\TH:i'), 'status' => 1, 'meta_title' => '',
    'meta_description' => '', 'tags' => '', 'is_featured' => 0, 'is_hot' => 0, 'enable_toc' => 1
];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        if ($postModel->create($data)) {
            ...
            $errors['db'] = "Lỗi: Không thể thêm bài viết. Vui lòng thử lại.";
        }
    }
}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted small">Tạo bài viết mới</p>
    </div>
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slug" name="slug" value="<?php echo htmlspecialchars($data['slug']); ?>" placeholder="Để trống để tự tạo từ tiêu đề">
                    </div>
                    <div class="mb-3">
