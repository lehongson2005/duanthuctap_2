<?php
// PHP logic for $path and $current_dir is moved to templates/header.php
// CSS is moved to a central stylesheet.
?>

<div class="sidebar offcanvas-lg offcanvas-start d-flex flex-column p-3" tabindex="-1" id="sidebarMenu">
    
    <div class="d-flex align-items-center justify-content-between mb-4 mt-2">
        <a href="<?php echo $path; ?>index.php" class="d-flex align-items-center text-dark text-decoration-none">
    ...
    <div class="offcanvas-body d-flex flex-column p-0">
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="<?php echo $path; ?>cruduser/list_users.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudcategories/list_categories.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudproducts/list_products.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudcategorylevel3/list_category_level3.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudiconmenu/list_icon_menu.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudbanner/list_banner.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudposts/list_posts.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudcncategories/list_cn_categories.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudcnposts/list_cn_posts.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudproducts_actual/list_products.php" 
            ...
            <li>
                <a href="<?php echo $path; ?>crudorders/list_orders.php" 
        ...
        <a href="<?php echo $path; ?>../admin/Auth/logout.php" class="text-danger text-decoration-none p-2">
